<?php
	...
	$menu[] = array('id' => 18, 'name' => 'S1.1', 'parents' => 17);
		...
		// tạo ra 1 mảng mới dựa vào mảng trên và có thêm trường lever với parents = 0 thì lever nó sẽ là 1 // xếp lại lever theo tăng dần
	...
	$menu1[] = array('id' => 6, 'name' => 'Tin trong nuoc', 'parents' => 3, 'level' => 2); //lever = 2  vì nó là con của new 
	$menu1[] = array('id' => 8, 'name' => 'CNTT', 'parents' => 6, 'level' => 3);  // tk con có lever = lever của cha + 1
