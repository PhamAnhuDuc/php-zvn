<?php
	$menu	= array();
	$menu[] = array('id' => 1, 'name' => 'Home', 'parents' => 0); //phần tử thứ 1 có id là 1 tên là Home có là con của con nào ko
	...
	$menu[] = array('id' => 6, 'name' => 'Tin trong nuoc', 'parents' => 3); //là con của menu new nên trường parent phải lưu id của cha
