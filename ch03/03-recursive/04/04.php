<?php
	...
	//hiển thị tất cả các phần tử trong arr menu : truyền vào menu - $source  - tham số parraen là số để thích duyệt cấp 1 2 hay 3
												//hàm chưa có giá trị trả vê thì dùng tham chiếu để thay đổi mảng
	function recursive($source, $parent, $level, &$newArray){
		if(count($source) > 0) { //nếu mảng k rỗng
