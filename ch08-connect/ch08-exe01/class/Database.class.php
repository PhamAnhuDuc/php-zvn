<?php
	...
	//Xây dựng 1 class để thao tác với cơ sở dữ liệu
class Database{
	...
	// EXIST : kiểm tra có tồn tại hay ko 
	public function isExist($query){ // truyền vào câu query
		if($query != null) { //nếu khác null thì thực hiện nó
